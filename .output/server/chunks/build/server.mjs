import { defineComponent, ref, inject, h, Suspense, hasInjectionContext, provide, shallowReactive, Fragment, getCurrentInstance, reactive, effectScope, isRef, isReactive, toRaw, getCurrentScope, onScopeDispose, watch, nextTick, toRefs, markRaw, computed, createElementBlock, shallowRef, cloneVNode, defineAsyncComponent, unref, useSSRContext, createApp, withCtx, createVNode, toRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, isReadonly, isShallow, mergeProps } from 'vue';
import { k as defuFn, l as klona, i as createError$1, m as defu, n as createDefu, o as hasProtocol, q as isScriptProtocol, r as joinURL, w as withQuery, v as sanitizeStatusCode, x as getContext, $ as $fetch$1, y as baseURL, z as createHooks, A as executeAsync, B as toRouteMatcher, C as createRouter$1 } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-D2K8uNE4.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-CMTcuLTX.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-CQy1TBew.mjs')
  },
  {
    name: "quality",
    path: "/quality",
    component: () => import('./quality-DPhjgc2d.mjs')
  },
  {
    name: "services",
    path: "/services",
    component: () => import('./services-DvypZ5Nm.mjs')
  },
  {
    name: "latest-news",
    path: "/latest-news",
    component: () => import('./index-COb3hzjX.mjs')
  },
  {
    name: "cleanroom-validation",
    path: "/cleanroom-validation",
    component: () => import('./cleanroom-validation-CgQ8b09P.mjs')
  },
  {
    name: "ucv-testing-htm-03-01",
    path: "/ucv-testing-htm-03-01",
    component: () => import('./ucv-testing-htm-03-01-DL6ixQfA.mjs')
  },
  {
    name: "compressed-air-testing",
    path: "/compressed-air-testing",
    component: () => import('./compressed-air-testing-BhsAQKSv.mjs')
  },
  {
    name: "latest-news-_newspage",
    path: "/latest-news/_newspage",
    component: () => import('./index-CJtXoba6.mjs')
  },
  {
    name: "breathing-air-quality-testing",
    path: "/breathing-air-quality-testing",
    component: () => import('./breathing-air-quality-testing-DmN0L98X.mjs')
  },
  {
    name: "clean-air-device-qualification",
    path: "/clean-air-device-qualification",
    component: () => import('./clean-air-device-qualification-DQggjqkf.mjs')
  },
  {
    name: "ki-discus-operator-protection-test",
    path: "/ki-discus-operator-protection-test",
    component: () => import('./ki-discus-operator-protection-test-C9y1OEf-.mjs')
  },
  {
    name: "lev-testing-local-exhaust-ventilation",
    path: "/lev-testing-local-exhaust-ventilation",
    component: () => import('./lev-testing-local-exhaust-ventilation-CjMpG6XH.mjs')
  },
  {
    name: "healthcare-ventilation-verification-htm-03-01",
    path: "/healthcare-ventilation-verification-htm-03-01",
    component: () => import('./healthcare-ventilation-verification-htm-03-01-DsSVQAYW.mjs')
  }
];
...
const namedMiddleware = {
  redirects: () => import('./redirects-5RleW0Yq.mjs')
};
...
const LazyIcon = defineAsyncComponent(() => import('./index-B5Wt8a7N.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CpmDm-uc.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DGsYKgit.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DCl9wfng.mjs'));
...
export { __nuxt_component_1 as _, appConfig as a, useRouter as b, useNuxtApp as c, useRuntimeConfig as d, entry$1 as default, nuxtLinkDefaults as e, useRoute as f, defineStore as g, useAppConfig as h, get as i, asyncDataDefaults as j, createError as k, looseToNumber as l, mergeConfig as m, navigateTo as n, omit as o, resolveRouteObject as r, twMerge as t, useHead as u };
