import { _ as __nuxt_component_0$1 } from './Container-DpXS18UO.mjs';
import { _ as __nuxt_component_0$2 } from './Link-D6MkXhLj.mjs';
import { _ as __nuxt_component_1$1, u as useUI, a as getULinkProps } from './Icon-DzycYtnF.mjs';
import { defineComponent, computed, mergeProps, withCtx, unref, createVNode, renderSlot, createBlock, createCommentVNode, openBlock, toDisplayString, toRef, useSSRContext } from 'vue';
import { twJoin } from 'tailwind-merge';
import { m as mergeConfig, t as twMerge, a as appConfig } from './server.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrRenderList, ssrRenderSlot, ssrInterpolate } from 'vue/server-renderer';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-header bg-[var(--color-dblue)] text-white py-8" }, _attrs))} data-v-337af541>`);
      _push(ssrRenderComponent(_component_UContainer, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="header-content" data-v-337af541${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UBreadcrumb, { links: unref(breadcrumbLinks) }, null, _parent2, _scopeId));
            _push2(`</div>`);
          } else {
            return [
              createVNode("div", { class: "header-content" }, [
                createVNode(_component_UBreadcrumb, { links: unref(breadcrumbLinks) }, null, 8, ["links"])
              ])
            ];
          }
        }),
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-337af541"]]), { __name: "PageHeader" });

export { __nuxt_component_0 as _ };
//# sourceMappingURL=pageHeader-ChVEVLUl.mjs.map
