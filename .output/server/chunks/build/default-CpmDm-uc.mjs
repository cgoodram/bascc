...
import { u as useUI, _ as __nuxt_component_1$2, g as getNuxtLinkProps } from './Icon-DzycYtnF.mjs';
import { _ as __nuxt_component_2$1 } from './Avatar-hXOE5YxQ.mjs';
import * as e from 'vue';
import { defineComponent, toRef, computed, useSSRContext, ref, provide, onMounted, onUnmounted, watchEffect, nextTick, watch, mergeProps, inject, useId, resolveComponent, withCtx, renderSlot, createVNode, resolveDynamicComponent, createTextVNode, toDisplayString, createBlock, createCommentVNode, openBlock, Fragment, renderList, Transition, unref, cloneVNode, h as h$1 } from 'vue';
import { twJoin } from 'tailwind-merge';
import { _ as __nuxt_component_1$1, m as mergeConfig, a as appConfig, t as twMerge } from './server.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderClass, ssrRenderStyle, ssrRenderList, ssrRenderVNode, ssrRenderAttr } from 'vue/server-renderer';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import { m as defu, p as publicAssetsURL } from '../_/nitro.mjs';
...
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$1]]), { __name: "UKbd" });
var r$2;
...
function P(e2, r2, { sorted: t2 = true, relativeTo: l2 = null, skipElements: o2 = [] } = {}) {
  var m;
  let i2 = (m = Array.isArray(e2) ? e2.length > 0 ? e2[0].ownerDocument : void 0 : e2 == null ? void 0 : e2.ownerDocument) != null ? m : void 0, n2 = Array.isArray(e2) ? t2 ? O$1(e2) : e2 : E(e2);
...
let ge = defineComponent({ name: "Menu", props: { as: { type: [Object, String], default: "template" } }, setup(o2, { slots: M, attrs: i$12 }) {
  let I2 = ref(1), p2 = ref(null), e2 = ref(null), r2 = ref([]), f$1 = ref(""), d2 = ref(null), g2 = ref(1);
  ...
  let l2 = { menuState: I2, buttonRef: p2, itemsRef: e2, items: r2, searchQuery: f$1, activeItemIndex: d2, activationTrigger: g2, closeMenu: () => {
    I2.value = 1, d2.value = null;
  }, openMenu: () => I2.value = 0, goToItem(t2, a2, n2) {
    let s3 = b2(), v2 = f(t2 === c.Specific ? { focus: c.Specific, id: a2 } : { focus: t2 }, { resolveItems: () => s3.items, resolveActiveIndex: () => s3.activeItemIndex, resolveId: (u2) => u2.id, resolveDisabled: (u2) => u2.dataRef.disabled });
...
} }), Se = defineComponent({ name: "MenuButton", props: { disabled: { type: Boolean, default: false }, as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(o2, { attrs: M, slots: i2, expose: I2 }) {
  var b2;
  let p2 = (b2 = o2.id) != null ? b2 : `headlessui-menu-button-${i$5()}`, e2 = O("MenuButton");
    ...
    switch (l2.key) {
      ...
      case o$1.ArrowDown:
        l2.preventDefault(), l2.stopPropagation(), e2.openMenu(), nextTick(() => {
          var t2;
          (t2 = o$2(e2.itemsRef)) == null || t2.focus({ preventScroll: true }), e2.goToItem(c.First);
        });
        break;
      case o$1.ArrowUp:
        l2.preventDefault(), l2.stopPropagation(), e2.openMenu(), nextTick(() => {
          var t2;
          (t2 = o$2(e2.itemsRef)) == null || t2.focus({ preventScroll: true }), e2.goToItem(c.Last);
        });
        break;
    }
  }
  ...
  let g2 = s2(computed(() => ({ as: o2.as, type: M.type })), e2.buttonRef);
  return () => {
    var n2;
...
} }), Me = defineComponent({ name: "MenuItems", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, id: { type: String, default: null } }, setup(o2, { attrs: M, slots: i$22, expose: I2 }) {
  var l$1;
  let p2 = (l$1 = o2.id) != null ? l$1 : `headlessui-menu-items-${i$5()}`, e2 = O("MenuItems"), r2 = ref(null);
  I2({ el: e2.itemsRef, $el: e2.itemsRef }), i$1({ container: computed(() => o$2(e2.itemsRef)), enabled: computed(() => e2.menuState.value === 0), accept(t2) {
  ...
  function f2(t2) {
    ...
    switch (r2.value && clearTimeout(r2.value), t2.key) {
      ...
      case o$1.Escape:
        ...
        break;
      case o$1.Tab:
        t2.preventDefault(), t2.stopPropagation(), e2.closeMenu(), nextTick(() => v$1(o$2(e2.buttonRef), t2.shiftKey ? N$1.Previous : N$1.Next));
        break;
      default:
  ...
  return () => {
    ...
    return A$1({ ourProps: n2, theirProps: a2, slot: t2, attrs: M, slots: i$22, features: N.RenderStrategy | N.Static, visible: b2.value, name: "MenuItems" });
  };
} }), be = defineComponent({ name: "MenuItem", inheritAttrs: false, props: { as: { type: [Object, String], default: "template" }, disabled: { type: Boolean, default: false }, id: { type: String, default: null } }, setup(o2, { slots: M, attrs: i2, expose: I2 }) {
  var v2;
  let p$1 = (v2 = o2.id) != null ? v2 : `headlessui-menu-item-${i$5()}`, e2 = O("MenuItem"), r2 = ref(null);
  I2({ el: r2, $el: r2 });
  ...
  function n2(u2) {
    t2.wasMoved(u2) && (o2.disabled || f2.value || e2.goToItem(c.Specific, p$1, 0));
  }
  function s3(u2) {
  ...
  return () => {
    ...
    return A$1({ ourProps: { id: p$1, ref: r2, role: "menuitem", tabIndex: u2 === true ? void 0 : -1, "aria-disabled": u2 === true ? true : void 0, onClick: b2, onFocus: l2, onPointerenter: a2, onMouseenter: a2, onPointermove: n2, onMousemove: n2, onPointerleave: s3, onMouseleave: s3 }, theirProps: { ...i2, ...h2 }, slot: C, attrs: i2, slots: M, name: "MenuItem" });
  };
} });
...
const _sfc_main$3 = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const containerStyle = computed(() => {
      ...
      const placement = popper2.value.placement?.split("-")[0];
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender]]), { __name: "UDropdown" });
const _imports_0$1 = publicAssetsURL("/imgs/bas-logo-dark.svg");
const _imports_0 = publicAssetsURL("/imgs/facebook.svg");
const _imports_1 = publicAssetsURL("/imgs/twitter.svg");
const _imports_2 = publicAssetsURL("/imgs/linkedin.svg");
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UNavigationBar = resolveComponent("UNavigationBar");
      const _component_UNavigationBarItem = resolveComponent("UNavigationBarItem");
      const _component_UDropdown = __nuxt_component_1;
      const _component_UIcon = __nuxt_component_1$2;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-089d2830><div class="top-bar" data-v-089d2830>`);
      _push(ssrRenderComponent(_component_UContainer, { class: "d-flex justify-content-between" }, {
        default: withCtx((_2, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="top-brand" data-v-089d2830${_scopeId}><img${ssrRenderAttr("src", _imports_0$1)} class="img-fluid" data-v-089d2830${_scopeId}></div><div class="top-contact" data-v-089d2830${_scopeId}><a href="tel:+441942870584" data-v-089d2830${_scopeId}>(01942) 870 584</a></div>`);
          } else {
            return [
              createVNode("div", { class: "top-brand" }, [
                createVNode("img", {
                  src: _imports_0$1,
                  class: "img-fluid"
                })
              ]),
              createVNode("div", { class: "top-contact" }, [
                createVNode("a", { href: "tel:+441942870584" }, "(01942) 870 584")
              ])
            ];
          }
        }),
      ...
      _push(`</div>`);
      _push(ssrRenderComponent(_component_UNavigationBar, null, {
        default: withCtx((_2, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UContainer, null, {
              left: withCtx((_22, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_UNavigationBarItem, { to: "/" }, {
                  ...
                  _push3(ssrRenderComponent(_component_UNavigationBarItem, { to: "/about" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`About`);
                      } else {
                  ...
                  _push3(ssrRenderComponent(_component_UNavigationBarItem, { to: "/quality" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`Quality`);
                      } else {
                  ...
                  _push3(ssrRenderComponent(_component_UDropdown, { items: unref(services) }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_UNavigationBarItem, null, {
                          trailing: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_UIcon, { name: "i-heroicons-chevron-down" }, null, _parent5, _scopeId4));
                            } else {
                              return [
                        ...
                        return [
                          createVNode(_component_UNavigationBarItem, null, {
                            trailing: withCtx(() => [
                              createVNode(_component_UIcon, { name: "i-heroicons-chevron-down" })
                            ]),
                            default: withCtx(() => [
                  ...
                  _push3(ssrRenderComponent(_component_UNavigationBarItem, { to: "/latest-news" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`Latest News`);
                      } else {
                  ...
                  _push3(ssrRenderComponent(_component_UNavigationBarItem, { to: "/contact" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`Contact Us`);
                      } else {
                  ...
                  return [
                    createVNode(_component_UNavigationBarItem, { to: "/" }, {
                      default: withCtx(() => [
                        createTextVNode("Home")
                      ]),
                      _: 1
                    }),
                    createVNode(_component_UNavigationBarItem, { to: "/about" }, {
                      default: withCtx(() => [
                        createTextVNode("About")
                      ]),
                      _: 1
                    }),
                    createVNode(_component_UNavigationBarItem, { to: "/quality" }, {
                      default: withCtx(() => [
                        createTextVNode("Quality")
                      ]),
                      _: 1
                    }),
                    createVNode(_component_UDropdown, { items: unref(services) }, {
                      default: withCtx(() => [
                        createVNode(_component_UNavigationBarItem, null, {
                          trailing: withCtx(() => [
                            createVNode(_component_UIcon, { name: "i-heroicons-chevron-down" })
                    ...
                    createVNode(_component_UNavigationBarItem, { to: "/latest-news" }, {
                      default: withCtx(() => [
                        createTextVNode("Latest News")
                      ]),
                      _: 1
                    }),
                    createVNode(_component_UNavigationBarItem, { to: "/contact" }, {
                      default: withCtx(() => [
                        createTextVNode("Contact Us")
                      ]),
                      _: 1
              ...
              right: withCtx((_22, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_UNavigationBarItem, {
                    href: "https://www.facebook.com/balancedairspecialists",
                    target: "_blank"
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img${ssrRenderAttr("src", _imports_0)} data-v-089d2830${_scopeId3}>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_UNavigationBarItem, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img${ssrRenderAttr("src", _imports_1)} data-v-089d2830${_scopeId3}>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_UNavigationBarItem, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img${ssrRenderAttr("src", _imports_2)} data-v-089d2830${_scopeId3}>`);
                      } else {
                        return [
                  ...
                  return [
                    createVNode(_component_UNavigationBarItem, {
                      href: "https://www.facebook.com/balancedairspecialists",
                      target: "_blank"
                    }, {
                      default: withCtx(() => [
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/headAndNav.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-089d2830"]]), { __name: "HeadAndNav" });
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UIcon = __nuxt_component_1$2;
      const _component_NuxtLink = __nuxt_component_0$1;
      _push(`<footer${ssrRenderAttrs(_attrs)} data-v-eec58718><div class="footer-main" data-v-eec58718>`);
      _push(ssrRenderComponent(_component_UContainer, null, {
        default: withCtx((_2, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="grid grid-cols-1 md:grid-cols-3 gap-8" data-v-eec58718${_scopeId}><div data-v-eec58718${_scopeId}><h2 data-v-eec58718${_scopeId}>Balanced Air Specialists</h2><p data-v-eec58718${_scopeId}>Experts in Cleanroom Validation</p><div class="socialLinks" data-v-eec58718${_scopeId}><a href="https://www.facebook.com/balancedairspecialists" target="_blank" data-v-eec58718${_scopeId}><img${ssrRenderAttr("src", _imports_0)} data-v-eec58718${_scopeId}></a><a href="https://twitter.com/balanced_air" target="_blank" data-v-eec58718${_scopeId}><img${ssrRenderAttr("src", _imports_1)} data-v-eec58718${_scopeId}></a><a href="https://www.linkedin.com/company/bascc" target="_blank" data-v-eec58718${_scopeId}><img${ssrRenderAttr("src", _imports_2)} data-v-eec58718${_scopeId}></a></div></div><div data-v-eec58718${_scopeId}><div class="header" data-v-eec58718${_scopeId}><h2 data-v-eec58718${_scopeId}>Services</h2></div><ul class="serviceList" data-v-eec58718${_scopeId}><!--[-->`);
            ssrRenderList(unref(services), (service) => {
              _push2(`<li class="service" data-v-eec58718${_scopeId}>`);
              ...
              _push2(ssrRenderComponent(_component_NuxtLink, {
                ...
                default: withCtx((_22, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(service.label)}`);
                  } else {
                    return [
            ...
            _push2(`<!--]--></ul></div><div class="contact" data-v-eec58718${_scopeId}><div class="header" data-v-eec58718${_scopeId}><h2 data-v-eec58718${_scopeId}>Contact us</h2></div><div class="contact-item" data-v-eec58718${_scopeId}><h3 class="title" data-v-eec58718${_scopeId}>Address:</h3><p data-v-eec58718${_scopeId}> Unit 4, Art Business Park,<br data-v-eec58718${_scopeId}> Newton-Le-Willows,<br data-v-eec58718${_scopeId}> Merseyside,<br data-v-eec58718${_scopeId}> WA12 8AT </p></div><div class="contact-item" data-v-eec58718${_scopeId}><h3 class="title" data-v-eec58718${_scopeId}>Email:</h3><p data-v-eec58718${_scopeId}><a href="mailto:info@bascc.co.uk" target="_blank" data-v-eec58718${_scopeId}> info@bascc.co.uk </a></p></div><div class="contact-item" data-v-eec58718${_scopeId}><h3 class="title" data-v-eec58718${_scopeId}>Phone:</h3><p data-v-eec58718${_scopeId}><a href="tel:+44194270584" target="_blank" data-v-eec58718${_scopeId}>(01942) 870 584</a></p></div></div></div>`);
          } else {
            return [
              createVNode("div", { class: "grid grid-cols-1 md:grid-cols-3 gap-8" }, [
                createVNode("div", null, [
                  createVNode("h2", null, "Balanced Air Specialists"),
                  createVNode("p", null, "Experts in Cleanroom Validation"),
                  createVNode("div", { class: "socialLinks" }, [
                    createVNode("a", {
                      href: "https://www.facebook.com/balancedairspecialists",
                      target: "_blank"
                    }, [
                ...
                createVNode("div", null, [
                  ...
                  createVNode("ul", { class: "serviceList" }, [
      ...
      _push(`</div><div class="sub-footer" data-v-eec58718>`);
      _push(ssrRenderComponent(_component_UContainer, null, {
        default: withCtx((_2, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` © copyright Balanced Air Specialist ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())}`);
          } else {
            return [
              createTextVNode(" © copyright Balanced Air Specialist " + toDisplayString((/* @__PURE__ */ new Date()).getFullYear()), 1)
            ];
          }
        }),
        _: 1
...
const __nuxt_component_2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-eec58718"]]), { __name: "Footer" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "default",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_HeadAndNav = __nuxt_component_0;
      const _component_NuxtPage = __nuxt_component_1$1;
      const _component_Footer = __nuxt_component_2;
      _push(`<div${ssrRenderAttrs(_attrs)}>`);
      _push(ssrRenderComponent(_component_HeadAndNav, null, null, _parent));
...
//# sourceMappingURL=default-CpmDm-uc.mjs.map
